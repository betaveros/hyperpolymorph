...
parse('c.html', ['c.txt', 'go.txt'])
parse('pascal.html', ['pascal.txt', 'ada.txt', 'plpgsql.txt'])
parse('lisp.html', ['common-lisp.txt', 'racket.txt', 'clojure.txt', 'c-sharp.txt'])
parse('ml.html', ['ocaml.txt', 'f-sharp.txt', 'scala.txt', 'haskell.txt'])
parse('logic.html', ['prolog.txt', 'erlang.txt'])
parse('stack.html', ['forth.txt', 'postscript.txt', 'factor.txt'])
parse('shell.html', ['posix-shell.txt', 'applescript.txt', 'powershell.txt'])
parse('data.html', ['sql.txt', 'awk.txt', 'pig.txt'])
parse('numerical-analysis.html', ['matlab.txt', 'r.txt', 'numpy.txt'])
parse('fortran.html', ['fortran.txt'])
parse('computer-algebra.html', ['mathematica.txt', 'sympy.txt', 'maxima.txt', 'pari-gp.txt'])
